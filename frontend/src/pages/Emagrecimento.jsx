    ...
    <div className="overflow-x-hidden">
      <div className="lg:grid lg:grid-cols-[1.65fr_1fr] bg-white">
        <div className="relative flex flex-col justify-center items-center p-6 lg:p-10 w-full mx-auto lg:mt-0 h-auto lg:h-[720px]">
          ...
          <div className="relative z-20 flex flex-col items-center text-center max-w-[500px] lg:max-w-[600px] xl:max-w-[700px] px-4">
  ...
  Após avaliação médica e nutricional, criamos um plano personalizado para alcançar resultados reais, com foco em saúde e equilíbrio.
            ...
            <div className="w-full flex justify-center">
              <div className="border-2 border-[#D3AF37] px-1 py-1 hover:scale-110 transform transition-transform duration-300 mb-4">
                <a
                  href="https://wa.me/5511945197405?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20processo%20de%20emagrecimento%20oferecido%20pela%20Blue%20Zone."
                  target="_blank"
                >
