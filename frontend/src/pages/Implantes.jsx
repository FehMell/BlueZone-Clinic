  ...
  const services = [
    {
      title: "Menopausa",
      description:
       <> Focado em melhorar a qualidade de vida das mulheres durante a menopausa, nosso tratamento tem como objetivo aliviar sintomas frequentemente incômodos, como <span className="font-semibold"> ondas de calor, instabilidade emocional, fadiga, insônia, baixa libido, suores noturnos, ressecamento vaginal, entre outros. </span> </>,
      icon: FaDumbbell,
      showButton: false,
    },
    {
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="relative flex flex-col justify-center items-center p-6 lg:p-10 w-full mx-auto lg:mt-0 h-auto lg:h-[720px]">
          ...
          <div className="relative z-20 flex flex-col items-center text-center max-w-[600px] lg:max-w-[800px] xl:max-w-[750px] px-4">
            ...
            <p className="pb-4 lg:pb-2 font-manrope text-gray-700 text-sm lg:text-[15px] xl:text-[16px] leading-relaxed">
              Implantes hormonais liberam doses estáveis e controladas
              diretamente na corrente sanguínea, oferecendo praticidade (sem
              doses diárias), maior constância nos níveis hormonais e duração
              prolongada (meses). Indicados para quem busca{" "}
              <span className="font-semibold">
                {" "}
                alívio de sintomas, melhora da energia, sono, libido e
            ...
            <p className="pb-2 lg:pb-2 font-manrope text-gray-700 text-sm lg:text-[15px] xl:text-[16px] leading-relaxed">
              ...
              avaliamos cada caso individualmente e indicamos o implante mais
              adequado — seja para{" "}
              <span className="font-semibold">
                {" "}
                reposição, anticoncepção, manejo da menopausa, ganho de massa
                muscular ou melhora da qualidade de vida.{" "}
              </span>
            </p>
      ...
      <div className="bg-black">
        <h2 className="uppercase text-center font-marcellus text-xl lg:text-[24px] xl:text-[24px] font-bold text-[#D3AF37] leading-tight pb-4 pt-12">
          Benefícios dos Implantes Hormonais
        </h2>
        <h2 className="uppercase text-center font-marcellus text-xl lg:text-[24px] xl:text-[24px] font-bold text-[#D3AF37] leading-tight pb-12">
          em comparação a outras formas de reposição
        </h2>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-10 relative z-10">
              ...
              <div className="flex flex-col justify-start text-gray-100 max-w-full lg:max-w-md text-center lg:text-left order-2 lg:order-2">
                ...
                <p className="text-center lg:text-left font-manrope pb-4 text-sm">
                  Proporcionam uma liberação gradual de hormônios, evitando
                  flutuações hormonais comuns em outros métodos, como
                  comprimidos e injeções, garantindo maior estabilidade no
                  tratamento.
                </p>
                ...
                <p className="font-manrope pb-4 text-sm">
                  Não exigem administração diária, eliminando o risco de
                  esquecimentos, típico de comprimidos e géis transdérmicos.
                </p>
                ...
                <p className="font-manrope pb-4 text-sm">
                  Implantes absorvíveis liberam hormônios por até 6 meses,
                  enquanto os não absorvíveis podem durar até 12 meses,
                  <br />
                ...
                <p className="font-manrope pb-4 text-sm">
                  Evitam o desconforto de injeções intramusculares regulares,
                  tornando o método mais prático e confortável para o paciente.
                </p>
                ...
                <p className="font-manrope pb-4 text-sm">
                  A liberação constante de hormônios bioidênticos, semelhantes
                  aos produzidos naturalmente pelo organismo, reduz os efeitos
                  colaterais indesejados e promove maior eficácia terapêutica.
                </p>
                ...
                <p className="font-manrope pb-4 text-sm">
                  Inseridos sob a pele, os implantes são praticamente
                  imperceptíveis, permitindo que o tratamento seja realizado sem
                  interferir na rotina do paciente.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="text-center ">
        ...
        <h2 className="font-manrope  lg:pt-6 pb-3 lg:pb-4 text-xs lg:text-sm text-gray-600 font-semibold">
        ...
        <p className="font-manrope lg:pb-8 text-gray-500 text-xs lg:text-sm max-w-2xl mx-auto px-4">
          ...
          menopausa, regular ciclos, melhorar libido, sono, humor e desempenho
          físico, além de oferecer opções contraceptivas e suporte na reposição
          masculina.
        </p>
      </div>
