  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 bg-white min-h-screen lg:min-h-auto">
      ...
      <div className="bg-white flex flex-col justify-center items-center p-4 sm:p-6 lg:p-8 w-full max-w-[95%] sm:max-w-[90%] lg:max-w-[500px] mx-auto lg:ml-34 mt-4 lg:mt-2 relative overflow-hidden order-2 lg:order-1">
        ...
        />
        <h2 className="text-center pb-2 font-marcellus text-base sm:text-lg lg:text-xl font-semibold text-[#D3AF37]">NUTROLOGIA NO JARDIM PAULISTA</h2>
        <h1 className="text-center font-marcellus text-xl sm:text-2xl lg:text-[38px] font-bold text-[#463D34] leading-tight">Saúde, Bem-Estar e</h1>
        <h1 className="text-center pb-3 sm:pb-4 font-marcellus text-xl sm:text-2xl lg:text-[38px] font-bold text-[#463D34] leading-tight">Qualidade de vida!</h1>
        ...
        <div className="text-center">
          <p className="text-xs font-manrope pt-3 sm:pt-4">DR. THIAGO GARCIA | CRM-SP 217222</p>
