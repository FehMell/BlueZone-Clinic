...
function Espaco() {
  ...
  return (
    <section className="relative w-full bg-black flex flex-col items-center justify-start py-16 px-4">
        ...
        >
          <div className="relative max-w-[95vw] max-h-[95vh] flex items-center justify-center">
            ...
            <img
              ...
              className={`max-w-full max-h-full object-contain shadow-2xl rounded-lg transition-opacity duration-300 ${imageLoading ? 'opacity-50' : 'opacity-100'}`}
              onClick={(e) => e.stopPropagation()}
            />
            
            <button
              onClick={closeImage}
              className="absolute top-4 right-4 bg-gray-800/90 hover:bg-gray-700 text-white p-2 rounded-full shadow-lg transition-all duration-200 w-10 h-10 flex items-center justify-center text-xl font-bold hover:scale-110 border border-gray-600"
            >
              ✕
            </button>
            ...
            <button
              ...
              className={`absolute left-4 top-1/2 transform -translate-y-1/2 bg-gray-800/90 hover:bg-gray-700 text-white p-3 rounded-full shadow-lg transition-all duration-200 w-12 h-12 flex items-center justify-center border border-gray-600 ${imageLoading ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'}`}
            >
            ...
            <button
              ...
              disabled={imageLoading}
              className={`absolute right-4 top-1/2 transform -translate-y-1/2 bg-gray-800/90 hover:bg-gray-700 text-white p-3 rounded-full shadow-lg transition-all duration-200 w-12 h-12 flex items-center justify-center border border-gray-600 ${imageLoading ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110'}`}
            >
              <span className="text-2xl font-bold -mt-0.5">›</span>
            </button>
            
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-gray-800/80 text-white px-3 py-1 rounded-full text-sm border border-gray-600">
